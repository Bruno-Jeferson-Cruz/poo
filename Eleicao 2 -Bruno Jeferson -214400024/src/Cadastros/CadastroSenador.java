...
public class CadastroSenador extends JFrame { 
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroSenador frame = new CadastroSenador();
	...
	public CadastroSenador() {
		...
		btnNewCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Senador s=new Senador(nome,partido,0,"Senador",numero);
				Senador sen=new Senador(nome,partido,0,"Senador",s.setNumero(numero));
				TelaInicial.cadastro(sen);
				setVisible(false);
			}
		});
		...
		JLabel lblNewLabel_3 = new JLabel("Cadastro de Senadores:");
