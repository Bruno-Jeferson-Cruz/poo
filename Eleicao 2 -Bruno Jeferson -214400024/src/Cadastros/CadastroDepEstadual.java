...
public class CadastroDepEstadual extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroDepEstadual frame = new CadastroDepEstadual();
	...
	public CadastroDepEstadual() {
		...
		btnNewCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DepEstadual dE=new DepEstadual(nome,partido,0,"DepEstadual",numero);
				DepEstadual depE=new DepEstadual(nome,partido,0,"DepEstadual",dE.setNumero(numero));
				TelaInicial.cadastro(depE);
				setVisible(false);
			}
		});
		...
		JLabel lblNewLabel_3 = new JLabel("Cadastro de Deputados Estaduais:");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_3.setBounds(89, 25, 291, 34);
