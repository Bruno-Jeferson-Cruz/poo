...
public class CadastroDepFederal extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroDepFederal frame = new CadastroDepFederal();
	...
	public CadastroDepFederal() {
		...
		btnNewCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DepFederal df=new DepFederal(nome,partido,0,"DepFederal",numero);
				DepFederal dpf=new DepFederal(nome,partido,0,"DepFederal",df.setNumero(numero));
				TelaInicial.cadastro(dpf);
				setVisible(false);
			}
		});
		...
		JLabel lblNewLabel_3 = new JLabel("Cadastro de Deputados Federais:");
