...
public class VotarGovernador extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VotarGovernador frame = new VotarGovernador();
	...
	public VotarGovernador() {
		...
		JLabel lblNewLabel = new JLabel("Numero do Candidato a Governador escolhido:");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel.setBounds(32, 204, 430, 25); 
		...
		textDados = new JTextArea(TelaInicial.viraString("Governador"));
