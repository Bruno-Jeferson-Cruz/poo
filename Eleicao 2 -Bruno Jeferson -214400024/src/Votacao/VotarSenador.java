...
public class VotarSenador extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VotarSenador frame = new VotarSenador();
	...
	public VotarSenador() {
		...
		JLabel lblNewLabel = new JLabel("Numero do Candidato a Senador escolhido:");
		...
		textDados = new JTextArea(TelaInicial.viraString("Senador"));
