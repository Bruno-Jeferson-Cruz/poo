...
public class VotarDepFederal extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VotarDepFederal frame = new VotarDepFederal();
	...
	public VotarDepFederal() {
		...
		JLabel lblNewLabel = new JLabel("Numero do Candidato a Dep.Federal escolhido:");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel.setBounds(44, 204, 430, 25); 
		...
		textDados = new JTextArea(TelaInicial.viraString("DepFederal"));
